...
@Component({
  ...
  template: `
    <div class="container mt-4">
      <div class="page-header">
        <div class="header-content">
          <div class="title-section">
            ...
            <p class="page-subtitle">Manage and monitor all your examinations</p>
          </div>
      ...
      <div *ngIf="!loading && !errorMsg && exams.length === 0" class="empty-state">
      ...
      <div class="exams-grid" *ngIf="!loading && !errorMsg && exams.length > 0">
        <div class="exam-card-wrapper" *ngFor="let exam of exams; trackBy: trackByExamId">
          <div class="exam-card" [class]="getExamStatusClass(exam).toLowerCase()">
              ...
              <div class="exam-stats">
                ...
                <div class="stat-item">
                  ...
                  <div class="stat-content">
                    ...
                    <span class="stat-value">{{ exam.startDate | date:'HH:mm' }}</span>
                  </div>
                </div>
                ...
                <div class="stat-item">
                  ...
                  <div class="stat-content">
                    ...
                    <span class="stat-value">{{ exam.endDate | date:'HH:mm' }}</span>
                  </div>
                </div>
               ...
               @if(isStudent &&  !(isTaken(exam.id) | async)) {
                ...
                <ng-container *ngIf="isTeacher">
                  <div class="teacher-actions">
                    ...
                    <button [routerLink]="['/exams/', exam.id, 'assign']" class="btn-secondary" title="Assign Students">
                      <i class="fas fa-users"></i>
                    </button>
                    <button (click)="deleteExam(exam.id)" class="btn-danger" title="Delete Exam">
  ...
  styles: [`
    ...
    .duration-icon { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); }
    .time-icon { background: linear-gradient(135deg, #28a745 0%, #20c997 100%); }
    .end-icon { background: linear-gradient(135deg, #dc3545 0%, #c82333 100%); }
    .score-icon { background: linear-gradient(135deg, #ffc107 0%, #e0a800 100%); }
    .pass-icon { background: linear-gradient(135deg, #17a2b8 0%, #138496 100%); }
