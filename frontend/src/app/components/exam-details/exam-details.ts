      ...
      <div *ngIf="!loading && exam">
            ...
            <div class="exam-info-grid">
              <div class="info-item">
                ...
                <div>
                  ...
                  <span class="info-value">{{ exam.startDate | date:'medium' }}</span>
                </div>
              </div>
              <div class="info-item">
        ...
        <ng-container *ngIf="isTeacher">
          <div class="students-section">
            <div class="section-header">
              ...
              <span class="student-count">{{ students.length }} students assigned</span>
            </div>
            ...
            <div class="students-content">
              ...
              <div *ngIf="!studentsLoading && students.length > 0" class="students-table">
                <table class="table table-hover">
                  ...
                  <tbody>
                    <tr *ngFor="let student of students">
                      ...
                      <td>
                        <span class="degree-badge" [class]="getDegreeClass(student.degree, exam?.minDegree)">
                          {{ student.degree }}
                        </span>
                      </td>
                      <td>
                        <span class="status-badge" [class]="student.isAbsent ? 'bg-danger' : 'bg-success'">
                        ...
                        <div class="performance-bar">
                          <div class="progress">
                            <div class="progress-bar" 
                                 [class]="getProgressBarClass(student.degree, exam?.maxDegree)"
                                 [style.width.%]="getProgressPercentage(student.degree, exam?.maxDegree)">
                            </div>
                          </div>
                          <small class="text-muted">{{ getProgressPercentage(student.degree, exam?.maxDegree) }}%</small>
                        </div>
                      </td>
                    </tr>
                  </tbody>
        ...
        <ng-container *ngIf="!isTeacher">
          <div class="student-view-section">
            <div class="section-header">
              <h4><i class="fas fa-user-graduate"></i> Your Exam Information</h4>
            </div>
            <div class="student-content">
              <div class="alert alert-info">
                <i class="fas fa-info-circle"></i>
                Your exam results, answers, and performance details will appear here once the exam is completed.
              </div>
            </div>
          </div>
        </ng-container>
  ...
  private async loadExamData(examId: string): Promise<void> {
    try {
      ...
      const [examData, studentsData] = await Promise.all([
        ...
        this.isTeacher ? this.examService.getStudentsOfExam(examId).toPromise() : Promise.resolve([])
      ]);
      ...
      this.loading = false;
      this.studentsLoading = false;
      this.errorMsg = 'Failed to load exam data: ' + (error instanceof Error ? error.message : String(error));
      this.cdr.detectChanges();
    }
  }
